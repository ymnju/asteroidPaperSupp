...
# 根据五院提供的小行星位置/相位角和时间的拟合结果, t>=1, 见2023.6.18记录
def dis_polynomial_expand(t):
    d = -8.6349241254e+05 + 2.6819572156e+06*(t**1) + -3.3841258961e+06*(t**2) + 2.3953322632e+06*(t**3) + -1.0736307244e+06*(t**4) + 3.2367035374e+05*(t**5) + -6.7705790331e+04*(t**6) + 9.9497295185e+03*(t**7) + -1.0236751651e+03*(t**8) + 7.2167475351e+01*(t**9) + -3.3195952319e+00*(t**10) + 8.9705293900e-02*(t**11) + -1.0796424661e-03*(t**12)
    phaseAngle = -1.0649333772e+04 + 3.2571255565e+04*(t**1) + -4.1242606334e+04*(t**2) + 2.9248796130e+04*(t**3) + -1.3095628255e+04*(t**4) + 3.9339386997e+03*(t**5) + -8.1854953457e+02*(t**6) + 1.1952210597e+02*(t**7) + -1.2211298068e+01*(t**8) + 8.5469086426e-01*(t**9) + -3.9033226923e-02*(t**10) + 1.0474486052e-03*(t**11) + -1.2522339945e-05*(t**12)
    return d,phaseAngle
